resource "aws_iam_role" "mwaa_execution_role" {
  name               = "mwaa_execution_role-${random_pet.suffix.id}"
...
resource "aws_iam_policy" "mwaa_policy" {
  name        = "mwaa_execution_policy-${random_pet.suffix.id}"
...
resource "aws_iam_role" "glue_execution_role" {
  name               = "glue_execution_role-${random_pet.suffix.id}"
...
resource "aws_iam_policy" "glue_policy" {
  name        = "glue_execution_policy-${random_pet.suffix.id}"
